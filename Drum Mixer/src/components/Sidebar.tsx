...
import { BookOpen, Disc, Music, Plus, Folder, FolderOpen, RefreshCw, CheckCircle2, Trash2, Star, RotateCcw, Search } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const [sortBy, setSortBy] = React.useState<'name' | 'bpm-asc' | 'bpm-desc' | 'practice' | 'confidence'>('name');
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-[10px] text-slate-500 font-mono">
                        {song.bpm} BPM {song.subtitle ? `• ${song.subtitle}` : ''}
                      </span>
                    </button>
