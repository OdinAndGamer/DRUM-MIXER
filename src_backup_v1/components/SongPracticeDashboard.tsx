...
export const SongPracticeDashboard: React.FC<SongPracticeDashboardProps> = ({
  ...
  // Log today in history if playCount increments
  useEffect(() => {
    if (!currentSong || stats.playCount === 0) return;
  ...
  }, [currentSong?.id, stats.playCount]);
      ...
      <div className="bg-brand-card border border-brand-border rounded-xl p-4 flex flex-col justify-start">
        ...
        <div className="space-y-1.5 border-t border-brand-border/40 pt-2">
          <div className="flex items-center justify-between text-[10px]">
            <span className="text-slate-500">Übungs-Sessions:</span>
            <span className="font-bold text-slate-300 font-mono">{stats.playCount} Mal</span>
          </div>
          <div className="flex items-center justify-between text-[10px]">
